...
call the function
	 <?php echoLarsensCalender( $day, $month, $year, $time, $howmany, $order, $international); ?>
...
e.g.: <?php echoLarsensCalender ( 1, 1, 1, 2, 10, 2, -1); ?> causes 26.10.2008 14:00 Uhr 
      <?php echoLarsensCalender ( 1, 1, 1, 2, 10, 2, 3); ?>  causes 26 Oct 2008 2.00 pm
